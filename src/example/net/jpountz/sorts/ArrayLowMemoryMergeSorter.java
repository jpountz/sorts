...
public class ArrayLowMemoryMergeSorter<T extends java.lang.Comparable<? super T>> extends LowMemoryMergeSorter {

  private final T[] arr;
  private final T[] savedSlots;

  public ArrayLowMemoryMergeSorter(T[] arr, int maxSavedSlots) {
    super(maxSavedSlots);
    @SuppressWarnings("unchecked")
    final T[] savedSlots = (T[]) new java.lang.Comparable[maxSavedSlots];
